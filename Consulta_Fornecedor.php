...
?>
  ...
  <button onclick="window.location.href='alterarFornecedor.php?id=<?php echo $row['codigo'];?>'">Alterar</button>

  <button onclick="window.location.href='excluirFornecedor.php?id=<?php echo $row['codigo'];?>'">Excluir</button>
