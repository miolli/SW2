...
<button onclick="window.location.href='alterarFuncionario.php?id=<?php echo $row['codigo'];?>'">Alterar</button>

<button onclick="window.location.href='excluirFuncionario.php?id=<?php echo $row['codigo'];?>'">Excluir</button>
