...
<?php
    ...
    try{
      ...
      while($row = $stmt->fetch()){
          ...
          echo "<br>";
?>
  <button onclick="window.location.href='alterarCliente.php?id=<?php echo $row['codigo'];?>'">Alterar</button>

  <button onclick="window.location.href='excluirCliente.php?id=<?php echo $row['codigo'];?>'">Excluir</button>
